...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_projects_selected_project" AS ENUM('none', '1', '2', '3', '4');
  ...
  CREATE TABLE "projects" (
  	...
  	"selected_project" "enum_projects_selected_project" DEFAULT 'none',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "services_use_cases_locales" (
  ...
  ALTER TABLE "services_use_cases_locales" ADD CONSTRAINT "services_use_cases_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."services_use_cases"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "services_use_cases_locales_locale_parent_id_unique" ON "services_use_cases_locales" USING btree ("_locale","_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "services_use_cases_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_projects_selected_project";`)
}
